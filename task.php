    ...
    <main class="container">
        ...
        if (isset($_POST['insert'])) {
            ...
            if (!empty($tarea)) {
                ...
                // si query fue exitoso Mostramos esto...
                if ($query) {
                    ?>
                    <div class="label__sucessfull">
                        <label>Agregado con exito!</label>
                    </div>
                <?php
                }
            } else {

                // Si no imprimimos esto en pantalla 
                ?>
